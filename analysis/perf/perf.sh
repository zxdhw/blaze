...
PERF_PARSED_LIST='/home/zxd/blaze/analysis/perf/list/'
PERF_PARSED_GRAPH='/home/zxd/blaze/analysis/perf/'
PERF_RES='/home/zxd/blaze/analysis/perf/tmp/'
...
for e in "${apps[@]}"
do
sudo perf report --cpu 11 --show-cpu-utilization -n --stdio -s symbol -i $PERF_RES/${EBPF}_${e}.out  > $PERF_PARSED_LIST/${EBPF}_${THREAD}_${e}.txt;
